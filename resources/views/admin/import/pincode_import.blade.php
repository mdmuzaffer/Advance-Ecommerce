        ...
        <div class="col-12">
          <div class="card">
			...
			<div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Import pincode</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" enctype='multipart/form-data' method="post" action="{{url('admin/import-pin')}}">
			  @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="brand" class="col-sm-2 col-form-label">{{$button}}</label>
                    <div class="col-sm-6">
                      <input type="file" class="form-control" id="import" placeholder="import pin" name="import">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
